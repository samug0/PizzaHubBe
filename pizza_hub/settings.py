"""
Django settings for pizza_hub project.
...
SECRET_KEY = 'django-insecure-l!)s=9n%v4q4$%&lq+iz^!omv(&%i2i5=!!s8r9*ofha-%8*17'
...
WSGI_APPLICATION = 'pizza_hub.wsgi.application'
